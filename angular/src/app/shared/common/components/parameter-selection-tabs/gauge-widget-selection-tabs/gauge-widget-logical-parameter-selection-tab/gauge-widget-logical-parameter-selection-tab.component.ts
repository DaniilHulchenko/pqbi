...
@Component({
    ...
    templateUrl: './gauge-widget-logical-parameter-selection-tab.component.html',
    styleUrl: './gauge-widget-logical-parameter-selection-tab.component.css',
})
export class GaugeWidgetLogicalParameterSelectionTabComponent
