...
import { FeederComponentInfo, NormalizeEnum, QuantityDataInfo, QuantityEnum } from '@shared/service-proxies/service-proxies';
...
export class GaugeWidgetAdditionalParameterSelectionTabComponent
