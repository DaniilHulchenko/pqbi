...
@Component({
    ...
    templateUrl: './channel-parameter-selection-tab.component.html',
    styleUrl: './channel-parameter-selection-tab.component.css',
})
export class ChannelParameterSelectionTabComponent
