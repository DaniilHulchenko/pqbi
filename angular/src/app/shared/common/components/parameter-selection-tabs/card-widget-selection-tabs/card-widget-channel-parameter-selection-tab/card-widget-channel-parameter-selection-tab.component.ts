...
@Component({
    ...
    templateUrl: './card-widget-channel-parameter-selection-tab.component.html',
    styleUrl: './card-widget-channel-parameter-selection-tab.component.css',
})
export class CardWidgetChannelParameterSelectionTabComponent
