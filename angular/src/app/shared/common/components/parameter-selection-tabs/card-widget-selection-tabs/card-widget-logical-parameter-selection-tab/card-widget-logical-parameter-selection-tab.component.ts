...
@Component({
    ...
    templateUrl: './card-widget-logical-parameter-selection-tab.component.html',
    styleUrl: './card-widget-logical-parameter-selection-tab.component.css',
})
export class CardWidgetLogicalParameterSelectionTabComponent
