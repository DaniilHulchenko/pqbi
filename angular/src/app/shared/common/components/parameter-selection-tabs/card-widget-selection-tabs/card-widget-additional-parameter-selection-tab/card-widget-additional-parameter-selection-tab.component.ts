...
import { QuantityEnum, NormalizeEnum, FeederComponentInfo, QuantityDataInfo } from '@shared/service-proxies/service-proxies';
...
@Component({
    ...
    templateUrl: './card-widget-additional-parameter-selection-tab.component.html',
    styleUrl: './card-widget-additional-parameter-selection-tab.component.css',
})
export class CardWidgetAdditionalParameterSelectionTabComponent
    ...
    implements PopulatableForm<WidgetParametersColumn>
{
    ...
    edit(parameter: WidgetParametersColumn) {
        ...
        this.advancedSettingsConfig = parameter.cardWidgetAdvancedSettings ?? this.defaultAdvancedSettingConfig
    }
    ...
    private editSave(isSilentInvoke: boolean = false) {
        ...
        for (let parameter of combinations) {
            ...
            (event.cardWidgetAdvancedSettings = this.advancedSettingsConfig
