namespace PQBI.Authorization
{
    ...
    public static class AppPermissions
    {
        ...
        public const string Pages_TrendWidgetConfigurations_Delete = "Pages.TrendWidgetConfigurations.Delete";

        public const string Pages_DefaultValues = "Pages.DefaultValues";
        public const string Pages_DefaultValues_Create = "Pages.DefaultValues.Create";
        public const string Pages_DefaultValues_Edit = "Pages.DefaultValues.Edit";
        public const string Pages_DefaultValues_Delete = "Pages.DefaultValues.Delete";

        public const string Pages_BarChartWidgetConfigurations = "Pages.BarChartWidgetConfigurations";
        public const string Pages_BarChartWidgetConfigurations_Create = "Pages.BarChartWidgetConfigurations.Create";
        public const string Pages_BarChartWidgetConfigurations_Edit = "Pages.BarChartWidgetConfigurations.Edit";
        public const string Pages_BarChartWidgetConfigurations_Delete = "Pages.BarChartWidgetConfigurations.Delete";

        public const string Pages_TableWidgetConfigurations = "Pages.TableWidgetConfigurations";
        public const string Pages_TableWidgetConfigurations_Create = "Pages.TableWidgetConfigurations.Create";
        public const string Pages_TableWidgetConfigurations_Edit = "Pages.TableWidgetConfigurations.Edit";
        public const string Pages_TableWidgetConfigurations_Delete = "Pages.TableWidgetConfigurations.Delete";

        public const string WidgetConfigurations = "WidgetConfigurations";
        public const string WidgetConfigurations_Create = "WidgetConfigurations.Create";
        public const string WidgetConfigurations_Edit = "WidgetConfigurations.Edit";
        public const string WidgetConfigurations_Delete = "WidgetConfigurations.Delete";

        public const string Pages_CustomParameters = "Pages.CustomParameters";
        public const string Pages_CustomParameters_Create = "Pages.CustomParameters.Create";
        public const string Pages_CustomParameters_Edit = "Pages.CustomParameters.Edit";
        public const string Pages_CustomParameters_Delete = "Pages.CustomParameters.Delete";
        ...
        public const string PQSPermission = "PQSPermission";
        public const string PQSTablePermission = "PQSTablePermission";
