...
{
    public class PQBIAsyncJwtBearerHandler : AuthenticationHandler<AsyncJwtBearerOptions>
    {
        ...
        /// </summary>
        /// <inheritdoc />
        public PQBIAsyncJwtBearerHandler(IOptionsMonitor<AsyncJwtBearerOptions> options,
