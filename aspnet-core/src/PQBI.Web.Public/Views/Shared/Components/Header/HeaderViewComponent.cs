...
using PQBI.Url;
using PQBI.Web.Public.Startup;
using PQBI.Web.Session;
using PQBI.Web.UiCustomization;

namespace PQBI.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : PQBIViewComponent
    {
