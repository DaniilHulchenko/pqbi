...
namespace PQBI.Web.Public.Startup
{
    [DependsOn(
        typeof(PQBIWebCoreModule)
    )]
    public class PQBIWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public PQBIWebFrontEndModule(IWebHostEnvironment env, PQBIEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(PQBIWebFrontEndModule).GetAssembly());
        }
    }
}
