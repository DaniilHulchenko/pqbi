...
using PQBI.Auditing.Exporting;
using PQBI.Authorization;
using PQBI.Authorization.Users;
using PQBI.Dto;
using PQBI.EntityHistory;
using EntityHistoryHelper = PQBI.EntityHistory.EntityHistoryHelper;

namespace PQBI.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : PQBIAppServiceBase, IAuditLogAppService
    {
