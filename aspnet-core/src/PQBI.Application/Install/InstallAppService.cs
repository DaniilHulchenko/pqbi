...
namespace PQBI.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : PQBIAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<PQBIDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{PQBIConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{PQBIConsts.ConnectionStringName}", constring);
        }
