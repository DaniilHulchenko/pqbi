...
using PQBI.Authorization.Users.Profile.Cache;
...
namespace PQBI.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : PQBIAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("PQBI",
