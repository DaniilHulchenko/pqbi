...
{
    public class SessionAppService : PQBIAppServiceBase, ISessionAppService
    {
            ...
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                var output = new GetCurrentLoginInformationsOutput
                {
                    Application = new ApplicationInfoDto
                    {
                        ...
                        Currency = PQBIConsts.Currency,
                        CurrencySign = PQBIConsts.CurrencySign,
                        AllowTenantsToChangeEmailSettings = PQBIConsts.AllowTenantsToChangeEmailSettings,
