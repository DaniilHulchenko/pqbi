...
namespace PQBI.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : PQBIServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("PQBI", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
