...
namespace PQBI.Authorization.Users
{
    ...
    public interface IUSertObjectMapperClonable : IObjectMapperClonable
    {
        string PQSSession { get; set; }
    }

    /// <summary>
    /// Represents a user in the system.
    /// </summary>
    public class User : AbpUser<User> , IUSertObjectMapperClonable
    {
        ...
        public string PQSSession { get; set; }
