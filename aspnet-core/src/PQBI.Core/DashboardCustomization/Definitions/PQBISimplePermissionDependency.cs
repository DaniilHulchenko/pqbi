...
/// </summary>
public class PQBISimplePermissionDependency : IPermissionDependency
{
    /// <summary>
    ...
    /// </summary>
    public PQBISimplePermissionDependency()
    {
    ...
    public PQBISimplePermissionDependency(params string[] permissions)
    {
    ...
    /// </param>
    /// <param name="permissions">The permissions.</param>
    public PQBISimplePermissionDependency(bool requiresAll, params string[] permissions)
        : this(permissions)
    {
