...
namespace PQBI.Configuration
{
    ...
    public class AppSettingProvider : SettingProvider
    {
        ...
        {
            if (!PQBIConsts.AllowTenantsToChangeEmailSettings)
            {
            ...
            return new[]
            {
                ...
                new SettingDefinition(AppSettings.Email.UseHostDefaultEmailSettings,
                    GetFromAppSettings(AppSettings.Email.UseHostDefaultEmailSettings,
                        PQBIConsts.MultiTenancyEnabled ? "true" : "false"), scopes: SettingScopes.Tenant)
            };
        }
        ...
        private IEnumerable<SettingDefinition> GetDashboardSettings()
        {
            ...
            return new[]
            {
                new SettingDefinition(
                    GetSettingName(
                        PQBIDashboardCustomizationConsts.Applications.Mvc,
                ...
                new SettingDefinition(
                    GetSettingName(
                        PQBIDashboardCustomizationConsts.Applications.Angular,
        ...
        public Dashboard GetDefaultMvcHostDashboardView()
        {
            ...
            {
                DashboardName = PQBIDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard,
                Pages = new List<Page>
                {
                    new Page($"Page_{PQBIDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard}_{PQBIDashboardCustomizationConsts.DefaultPageUniqueName}_{1}")
                    {
                        Name = PQBIDashboardCustomizationConsts.DefaultPageName,
                        Widgets = new List<Widget>
                        {
                            new Widget
                            {
                                WidgetId = PQBIDashboardCustomizationConsts.Widgets.Host
                                    .TopStats, // Top Stats
                                Height = 6,
                                Width = 12,
                                PositionX = 0,
                            ...
                            {
                                WidgetId =
                                    PQBIDashboardCustomizationConsts.Widgets.Host
        ...
        public Dashboard GetDefaultMvcTenantDashboardView()
        {
            ...
            return new Dashboard
            {
                DashboardName = PQBIDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard,
                Pages = new List<Page>
                {
                    new Page($"Page_{PQBIDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard}_{PQBIDashboardCustomizationConsts.DefaultPageUniqueName}_{1}")
                    {
                        Name = PQBIDashboardCustomizationConsts.DefaultPageName,
                        Widgets = new List<Widget>
                        {
                            new Widget
                            {
                                WidgetId = PQBIDashboardCustomizationConsts.Widgets.Tenant
                                    .GeneralStats, // General Stats
                                Height = 9,
                                Width = 6,
                                PositionX = 0,
                                PositionY = 19,
                                WidgetGuid = string.Empty
                            },
                            new Widget
                            {
                                WidgetId = PQBIDashboardCustomizationConsts.Widgets.Tenant
                            ...
                            {
                                WidgetId =
                                    PQBIDashboardCustomizationConsts.Widgets.Tenant
