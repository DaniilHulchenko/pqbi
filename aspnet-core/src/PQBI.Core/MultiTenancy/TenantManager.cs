        ...
        IEventHandler<RecurringPaymentSucceedEventData>
    {
            ...
            )
        {
            ...
            if (isInTrialPeriod && !subscriptionEndDate.HasValue)
            {
                throw new UserFriendlyException(LocalizationManager.GetString(
                    PQBIConsts.LocalizationSourceName, "TrialWithoutEndDateErrorMessage"));
            }
            ...
            using (var uow = _unitOfWorkManager.Begin(TransactionScopeOption.RequiresNew))
            {
                ...
                using (_unitOfWorkManager.Current.SetTenantId(tenant.Id))
                {
                    ...
                    await _roleManager.CreatePredefinedRoles();
        ...
        public async Task CheckEditionAsync(int? editionId, bool isInTrialPeriod)
        {
            await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                ...
                var error = LocalizationManager.GetSource(PQBIConsts.LocalizationSourceName)
        ...
        public void HandleEvent(RecurringPaymentSucceedEventData eventData)
        {
            _unitOfWorkManager.WithUnitOfWork(() =>
            {
                ...
                if (editionItem == null || !editionItem.Product.Equals(PQBIConsts.ProductName))
                {
                    Logger.Warn(
                        $"This is not a payment for {PQBIConsts.ProductName} for edition subscription cycle! " +
