...
namespace PQBI.MultiTenancy.Demo
{
    /// <summary>
    ...
    /// </summary>
    public class TenantDemoDataBuilder : PQBIServiceBase, ITransientDependency
    {
        ...
        private async Task BuildForInternalAsync(Tenant tenant)
        {
            ...
            foreach (var user in users)
            {
                ...
                //Add to roles
                await _userManager.AddToRoleAsync(user, StaticRoleNames.Tenants.Viewer);
