...
using PQBI.Core.Base;
using PQBI.Core.Extensions;
using PQBI.Dto;
using PQBI.Types;

namespace PQBI.Queries
{
    public class OrganizationUnitQuery : PQBIQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
