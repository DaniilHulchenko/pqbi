...
using PQBI.EntityFrameworkCore.Repositories;

namespace PQBI.Organizations
{
    public class UserOrganizationUnitRepository : PQBIRepositoryBase<UserOrganizationUnit, long>,
        IUserOrganizationUnitRepository
    {
        public UserOrganizationUnitRepository(IDbContextProvider<PQBIDbContext> dbContextProvider)
