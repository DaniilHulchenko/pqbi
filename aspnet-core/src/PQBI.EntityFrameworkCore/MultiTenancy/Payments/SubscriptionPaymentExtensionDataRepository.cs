...
{
    public class SubscriptionPaymentExtensionDataRepository : PQBIRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<PQBIDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
