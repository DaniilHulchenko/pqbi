...
using PQBI.Mobile.MAUI.Helpers;

#if ANDROID
using PQBI.Mobile.MAUI.Platforms.Android.HttpClient;
#endif
...
#elif IOS
            var abpHttpClientFactory = new PQBI.Mobile.MAUI.Platforms.iOS.iOSHttpClientFactory
            {
                OnSessionTimeOut = App.OnSessionTimeout,
                OnAccessTokenRefresh = App.OnAccessTokenRefresh
            };
