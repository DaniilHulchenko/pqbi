...
using PQBI.MultiTenancy.HostDashboard;
...
namespace PQBI.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(PQBIDbContext context, SubscriptionPayment subscriptionPayment)
        {
